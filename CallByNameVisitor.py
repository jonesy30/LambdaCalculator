...
class CallByNameVisitor(BaseVisitor):
    ...
    def visitApplication(self, ctx:LambdaCalculusParser.ApplicationContext):
        ...
        if isinstance(am_I_an_abstraction,LambdaCalculusParser.AbstractionContext):
            ...
            #NOTE: is this right?
            #Get the type of the RHS of the abstraction
            _, expression_type = self.visit(ctx.getChild(1))
    ...
    def visitAbstraction(self, ctx:LambdaCalculusParser.AbstractionContext):
        ...
        #NOTE: HERE! I CAN PUT IT IN HERE (I can also maybe set the integers to be ints here too?)
        ...
        print("New function after adding bound variable type = "+new_function)
