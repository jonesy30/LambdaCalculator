...
def get_scopes(expression):
    ...
    for scope in scope_objects:
        print(str(scope.id))
        print("Contents of bracket stack: "+str(scope.brackets))
        if scope.end_index is None:
            scope.end_index = len(expression)

    print(str(scope_objects))
...
def rename_values(expression,scope_map,scope_objects):
    ...
    for scope in scope_objects:
        ...
        # print("Id = "+str(scope.id))
        # print("Start = "+str(scope.start_index))
        # print("End = "+str(scope.end_index))
