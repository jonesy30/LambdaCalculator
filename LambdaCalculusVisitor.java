...
public interface LambdaCalculusVisitor<T> extends ParseTreeVisitor<T> {
	...
	/**
	 * Visit a parse tree produced by {@link LambdaCalculusParser#parenthesis}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitParenthesis(LambdaCalculusParser.ParenthesisContext ctx);
	/**
	...
	/**
	 * Visit a parse tree produced by {@link LambdaCalculusParser#expression}.
	 * @param ctx the parse tree
	 * @return the visitor result
	 */
	T visitExpression(LambdaCalculusParser.ExpressionContext ctx);
	/**
