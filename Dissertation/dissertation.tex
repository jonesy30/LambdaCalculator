...
The final tool can be accessed at http://haiti.dcs.gla.ac.uk:5000/ from machines within the University of Glasgow.
\end{abstract}
\newpage
\addtocontents{toc}{\protect\thispagestyle{empty}\tiny}
\tableofcontents
\newpage
